...
<template>
  <div class="card">
    <div class="fb-font-semibold fb-text-xl fb-mb-4">Filtering</div>
    <DataTable
      :value="customers1"
      :paginator="true"
      :rows="10"
    ...
    >
      ...
      <Column field="activity" header="Activity" :showFilterMatchModes="false" style="min-width: 12rem">
        ...
        <template #filter="{ filterModel }">
          <Slider v-model="filterModel.value" range class="fb-m-4"></Slider>
          <div class="fb-flex fb-items-center fb-justify-between fb-px-2">
  ...
  <div class="card">
    <div class="fb-font-semibold fb-text-xl fb-mb-4">Frozen Columns</div>
    <ToggleButton v-model="balanceFrozen" onIcon="pi pi-lock" offIcon="pi pi-lock-open" onLabel="Balance" offLabel="Balance" />

    <DataTable :value="customers2" scrollable scrollHeight="400px" class="fb-mt-6">
      <Column field="name" header="Name" style="min-width: 200px" frozen class="fb-font-bold"></Column>
      ...
      <Column field="balance" header="Balance" style="min-width: 200px" alignFrozen="right" :frozen="balanceFrozen">
        <template #body="{ data }">
          <span class="fb-font-bold">{{ formatCurrency(data.balance) }}</span>
        </template>
      </Column>
    </DataTable>
  </div>
  ...
  <div class="card">
    <div class="fb-font-semibold fb-text-xl fb-mb-4">Row Expansion</div>
    <DataTable v-model:expandedRows="expandedRows" :value="products" dataKey="id" tableStyle="min-width: 60rem">
      <template #header>
        <div class="fb-flex fb-flex-wrap fb-justify-end fb-gap-2">
  ...
  <div class="card">
    <div class="fb-font-semibold fb-text-xl fb-mb-4">Grouping</div>
    <DataTable
      :value="customers3"
    ...
    >
      ...
      <template #groupfooter="slotProps">
        <div class="fb-flex fb-justify-end fb-font-bold fb-w-full">Total Customers: {{ calculateCustomerTotal(slotProps.data.representative.name) }}</div>
      </template>
    </DataTable>
  </div>
</template>
