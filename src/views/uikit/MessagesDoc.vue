...
<template>
  <div class="fb-flex fb-flex-col md:fb-flex-row fb-gap-8">
    <div class="md:fb-w-1/2">
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">Toast</div>
        ...
        <div class="fb-font-semibold fb-text-xl fb-mt-4 fb-mb-4">Inline</div>
        <div class="fb-flex fb-flex-wrap fb-mb-4 fb-gap-2">
    ...
    <div class="md:fb-w-1/2">
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">Message</div>
        <div class="fb-flex fb-flex-col fb-gap-4 fb-mb-4">
