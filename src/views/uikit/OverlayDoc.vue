...
<template>
  <div class="fb-flex fb-flex-col md:fb-flex-row fb-gap-8">
    <div class="md:fb-w-1/2">
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">Dialog</div>
      ...
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">Popover</div>
      ...
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">Tooltip</div>
        <div class="fb-inline-flex fb-gap-4">
    ...
    <div class="md:fb-w-1/2">
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">Drawer</div>
      ...
      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">ConfirmPopup</div>
        <ConfirmPopup></ConfirmPopup>
        <Button ref="popup" @click="confirm($event)" icon="pi pi-check" label="Confirm" class="fb-mr-2"></Button>
      </div>

      <div class="card">
        <div class="fb-font-semibold fb-text-xl fb-mb-4">ConfirmDialog</div>
        ...
        <Dialog header="Confirmation" v-model:visible="displayConfirmation" :style="{ width: '350px' }" :modal="true">
          <div class="fb-flex fb-items-center fb-justify-center">
            <i class="pi pi-exclamation-triangle fb-mr-4" style="font-size: 2rem" />
