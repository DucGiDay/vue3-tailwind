...
<template>
  <div
    class="config-panel fb-hidden fb-absolute fb-top-[3.25rem] fb-right-0 fb-w-64 fb-p-4 fb-bg-surface-0 dark:fb-bg-surface-900 fb-border fb-border-surface fb-rounded-border fb-origin-top fb-shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)]"
  >
    <div class="fb-flex fb-flex-col fb-gap-4">
      <div>
        <span class="fb-text-sm fb-text-muted-color fb-font-semibold">Primary</span>
        <div class="fb-pt-2 fb-flex fb-gap-2 fb-flex-wrap fb-justify-between">
          <button
      ...
      <div>
        <span class="fb-text-sm fb-text-muted-color fb-font-semibold">Surface</span>
        <div class="fb-pt-2 fb-flex fb-gap-2 fb-flex-wrap fb-justify-between">
          <button
            ...
            :class="[
              'fb-border-none fb-w-5 fb-h-5 fb-rounded-full fb-p-0 fb-cursor-pointer fb-outline-none fb-outline-offset-1',
              {
                'fb-outline-primary': layoutConfig.surface
