<template>
  <div id="features" class="fb-py-6 fb-px-6 lg:fb-px-20 fb-mt-8 fb-mx-0 lg:fb-mx-20">
    <div class="fb-grid fb-grid-cols-12 fb-gap-4 fb-justify-center">
      <div class="fb-col-span-12 fb-text-center fb-mt-20 fb-mb-6">
        <div class="fb-text-surface-900 dark:fb-text-surface-0 fb-font-normal fb-mb-2 fb-text-4xl">Marvelous Features</div>
        <span class="fb-text-muted-color fb-text-2xl">Placerat in egestas erat...</span>
      </div>

      <div class="fb-col-span-12 md:fb-col-span-12 lg:fb-col-span-4 fb-p-0 lg:fb-pr-8 lg:fb-pb-8 fb-mt-6 lg:fb-mt-0">
        <div
          style="
            height: 160px;
            padding: 2px;
      ...
      <div class="fb-col-span-12 md:fb-col-span-12 lg:fb-col-span-4 fb-p-0 lg:fb-pb-8 fb-mt-6 lg:fb-mt-0">
        <div
          style="
            height: 160px;
            padding: 2px;
        ...
        >
          <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
            <div class="fb-flex fb-items-center fb-justify-center fb-bg-indigo-200" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
              <i class="pi pi-fw pi-map !fb-text-2xl fb-text-indigo-700"></i>
            </div>
      ...
      <div class="fb-col-span-12 md:fb-col-span-12 lg:fb-col-span-4 fb-p-0 lg:fb-pr-8 lg:fb-pb-8 fb-mt-6 lg:fb-mt-0">
        ...
        >
          <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
            <div class="fb-flex fb-items-center fb-justify-center fb-bg-slate-200 fb-mb-4" style="width: 3.5rem; height: 3.5rem; border-radius: 10px">
              <i class="pi pi-fw pi-id-card !fb-text-2xl fb-text-slate-700"></i>
            </div>
      ...
      <div class="fb-col-span-12 md:fb-col-span-12 lg:fb-col-span-4 fb-p-0 lg:fb-pr-8 fb-mt-6 lg:fb-mt-0">
        <div
          style="
            height: 160px;
            padding: 2px;
      ...
      <div class="fb-col-span-12 md:fb-col-span-12 lg:fb-col-span-4 fb-p-0 lg-4 fb-mt-6 lg:fb-mt-0">
        <div
          style="
            height: 160px;
            padding: 2px;
      ...
      <div
        class="fb-col-span-12 fb-mt-20 fb-mb-20 fb-p-2 md:fb-p-20"
        style="
          border-radius: 20px;
        ...
        "
      >
        <div class="fb-flex fb-flex-col fb-justify-center fb-items-center fb-text-center fb-px-4 fb-py-4 md:fb-py-0">
          <div class="fb-text-gray-900 fb-mb-2 fb-text-3xl fb-font-semibold">Joséphine Miller</div>
          <span class="fb-text-gray-600 fb-text-2xl">Peak Interactive</span>
          <p class="fb-text-gray-900 sm:fb-line-height-2 md:fb-line-height-4 fb-text-2xl fb-mt-6" style="max-width: 800px">
            “Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat
            non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.”
          </p>
          <img src="/demo/images/landing/peak-logo.svg" class="fb-mt-6" alt="Company logo" />
        </div>
      </div>
    </div>
  </div>
