  ...
  >
    ...
    <Fluid v-else class="fb-space-y-6">
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="partner" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Đối tác
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="store" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Cửa hàng
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="posId" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          POS ID
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="inv_user_name" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Tài khoản
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="inv_password" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Mật khẩu
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="inv_tax_code" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Mã số thuế
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="inv_series" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Ký hiệu
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label
          for="inv_template_id"
          class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2"
        >
          Mẫu hóa đơn
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
      ...
      <div class="fb-grid fb-grid-cols-12 fb-gap-1">
        <label for="version" class="fb-flex fb-items-center fb-col-span-12 md:fb-col-span-2">
          Phiên bản
          <span class="fb-text-error fb-ml-1">*</span>
        </label>
        <div class="fb-col-span-12 md:fb-col-span-10">
